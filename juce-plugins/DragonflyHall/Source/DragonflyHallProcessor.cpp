...
static Bank banks[NUM_BANKS] = {
  {
    "Unify Custom", {           // dry,  early, late,    size, width, delay, diffuse, low cut, low xo,  low mult, high cut, high xo, high mult, spin, wander, decay, e. send, modulation
      ...
      {"String Hall",           { 90.0, 22.42,  12.5,    42.0, 100.0, 15.44,   100.0,   325.0, 1200.0,   1.52622,  8690.08,  7158.91,      1.2, 4.23,  17.52,     1.4,  20.0, 45.0  }},
      {"Mysterious Hall",       { 90.0,   8.0,  12.5,    40.0, 150.0,  20.0,    60.0,   180.0,  600.0,       2.5,  8848.75,  5052.81,      0.2,  3.0,   35.0,    5.09, 100.0, 30.0  }},
      {"Fantasy Hall",          { 90.0,  13.0,  26.0,    42.1, 150.0, 15.44,   100.0,   253.4, 1200.0,   1.52622,  3033.91,  9080.55, 0.620609, 1.25,  25.08,  5.6777,  20.0, 75.86 }},
    }
  },
  {
