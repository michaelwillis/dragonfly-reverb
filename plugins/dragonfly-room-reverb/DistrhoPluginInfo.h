...
static Param params[paramCount] = {
  ...
  {"Boost Band",   "boost_band",     1.0f,     4.0f,   "x"}
};
...
static Bank banks[NUM_BANKS] = {
  {
    "Small", {               // dry, early, e. send, late, size, width, delay, decay, diffuse, spin, wander, in damp, early damp, late damp, bass boost, boost lpf, boost band
      {"Small Bright Room",  { 80.0,  10.0,    20.0, 20.0,  8.0,  90.0,   4.0,   0.2,    60.0,  0.4,   40.0,   16000,      16000,     16000,       20.0,       600,        4.0}},
      {"Small Clear Room",   { 80.0,  10.0,    20.0, 20.0,  8.0,  90.0,   4.0,   0.2,    60.0,  0.8,   40.0,   16000,      14000,     12500,       40.0,       600,        4.0}},
      {"Small Dark Room",    { 80.0,  10.0,    20.0, 20.0,  8.0,  90.0,   4.0,   0.3,    70.0,  1.6,   20.0,   16000,      12000,      9000,       60.0,      1000,        4.0}},
      {"Small Drum Room",    { 80.0,  10.0,    20.0, 20.0,  9.0,  90.0,   8.0,   0.2,    24.0,  2.1,   10.0,   16000,       9000,      7000,       40.0,       400,        4.0}},
      {"Small Vocal Room",   { 80.0,  10.0,    20.0, 20.0,  8.0,  90.0,   0.0,   0.3,    86.0,  2.4,   12.0,   16000,       8000,      7000,       20.0,       400,        4.0}}
    }
  },
  {
    "Medium", {              // dry, early, e. send, late, size, width, delay, decay, diffuse, spin, wander, in damp, early damp, late damp, bass boost, boost lpf, boost band
      {"Medium Bright Room", { 80.0,  10.0,    20.0, 20.0, 12.0, 100.0,   8.0,   0.4,    60.0,  0.4,   40.0,   16000,      16000,     14000,       25.0,       600,        4.0}},
      {"Medium Clear Room",  { 80.0,  10.0,    20.0, 20.0, 12.0, 100.0,   8.0,   0.4,    70.0,  0.8,   40.0,   16000,      14000,     12000,       50.0,       600,        4.0}},
      {"Medium Dark Room",   { 80.0,  10.0,    20.0, 20.0, 12.0, 100.0,   8.0,   0.5,    70.0,  1.6,   20.0,   16000,      10000,      8000,       70.0,      1000,        4.0}},
  ...
  {
    "Large", {               // dry, early, e. send, late, size, width, delay, decay, diffuse, spin, wander, in damp, early damp, late damp, bass boost, boost lpf, boost band
      {"Large Bright Room",  { 80.0,  10.0,    20.0, 20.0, 15.0, 100.0,  12.0,   0.7,    70.0,  0.4,   40.0,   16000,      16000,     14000,       30.0,       600,        4.0}},
      {"Large Clear Room",   { 80.0,  10.0,    20.0, 20.0, 15.0, 100.0,  12.0,   0.7,    80.0,  0.4,   40.0,   16000,      14000,     12000,       60.0,       600,        4.0}},
      {"Large Dark Room",    { 80.0,  10.0,    20.0, 20.0, 15.0, 100.0,  12.0,   0.8,    80.0,  1.6,   20.0,   16000,      10000,      7000,       80.0,      1000,        4.0}},
  ...
  {
    "Halls", {               // dry, early, e. send, late, size, width, delay, decay, diffuse, spin, wander, in damp, early damp, late damp, bass boost, boost lpf, boost band
  ...
  {
    "Effects", {             // dry, early, e. send, late, size, width, delay, decay, diffuse, spin, wander, in damp, early damp, late damp, bass boost, boost lpf, boost band
      {"Bright Plate",       { 80.0,  10.0,    20.0, 20.0, 10.0, 100.0,   0.0,   1.8,    78.0,  1.6,   40.0,   16000,      16000,     15000,       10.0,      1000,        4.0}},
      {"Dark Plate",         { 80.0,  10.0,    20.0, 20.0, 10.0, 100.0,   0.0,   2.0,    78.0,  0.4,   20.0,   16000,      12000,      9000,       40.0,       500,        4.0}},
