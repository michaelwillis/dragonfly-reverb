...
static Bank banks[NUM_BANKS] = {
  {
    "Rooms", {                   // dry, early,  late, size, width, delay, diffuse, low cut, low xo, low mult, high cut, high xo, high mult, spin, wander
      {"Bright Room",            { 80.0,  10.0,  10.0, 10.0,  90.0,   4.0,    90.0,     4.0,    500,     0.80,    15000,    8000,      0.75,  1.0, 25.0 }},
      {"Clear Room",             { 80.0,  10.0,  10.0, 10.0,  90.0,   4.0,    90.0,     4.0,    500,     0.90,    12000,    6000,      0.50,  1.0, 25.0 }},
      {"Dark Room",              { 80.0,  10.0,  10.0, 10.0,  90.0,   4.0,    50.0,     4.0,    500,     1.20,     7200,    5000,      0.35,  1.0, 25.0 }},
      {"Small Chamber",          { 80.0,  10.0,  15.0, 16.0,  80.0,   8.0,    70.0,     4.0,    500,     1.10,     8000,    5500,      0.35,  1.2, 10.0 }},
      {"Large Chamber",          { 80.0,  10.0,  15.0, 20.0,  80.0,   8.0,    90.0,     4.0,    500,     1.30,     7200,    5000,      0.25,  1.8, 12.0 }},
    }
  },
  {
    "Studios", {                 // dry, early,  late, size, width, delay, diffuse, low cut, low xo, low mult, high cut, high xo, high mult, spin, wander
      {"Acoustic Studio",        { 85.0,   5.0,  10.0, 12.0,  90.0,   8.0,    75.0,     4.0,    450,     1.50,     7600,    5000,      0.80,  2.5,  7.0 }},
      {"Electric Studio",        { 85.0,   5.0,  10.0, 12.0,  90.0,   6.0,    45.0,     4.0,    250,     1.25,     7600,    6000,      0.70,  2.5,  7.0 }},
      {"Percussion Studio",      { 90.0,   0.0,  10.0, 12.0,  90.0,   6.0,    30.0,    20.0,    200,     1.75,     6000,    5000,      0.45,  2.5,  7.0 }},
      {"Piano Studio",           { 90.0,   5.0,  10.0, 12.0,  80.0,   8.0,    40.0,    20.0,    600,     1.50,     8000,    6000,      0.50,  2.8, 10.0 }},
      {"Vocal Studio",           { 90.0,   0.0,  10.0, 12.0,  80.0,   0.0,    60.0,     4.0,    400,     1.20,     6000,    5000,      0.40,  2.5,  7.0 }},
    }
  },
  {
    "Small Halls", {             // dry, early,  late, size, width, delay, diffuse, low cut, low xo, low mult, high cut, high xo, high mult, spin, wander
      ...
      {"Small Clear Hall",       { 80.0,  10.0,  15.0, 24.0, 100.0,   4.0,    90.0,     4.0,    500,     1.30,     7600,    5500,      0.50,  3.3, 15.0 }},
      {"Small Dark Hall",        { 80.0,  10.0,  15.0, 24.0, 100.0,  12.0,    60.0,     4.0,    500,     1.50,     6000,    4000,      0.35,  2.5, 10.0 }},
      {"Small Percussion Hall",  { 85.0,   0.0,  15.0, 24.0,  80.0,  12.0,    40.0,    20.0,    250,     2.00,     5000,    4500,      0.35,  2.0, 13.0 }},
      {"Small Vocal Hall",       { 85.0,   0.0,  15.0, 24.0,  80.0,   4.0,    60.0,     4.0,    500,     1.25,     6000,    5000,      0.35,  3.1, 15.0 }},
    }
  },
  {
    "Medium Halls", {            // dry, early,  late, size, width, delay, diffuse, low cut, low xo, low mult, high cut, high xo, high mult, spin, wander
      ...
      {"Medium Clear Hall",      { 80.0,   5.0,  20.0, 30.0, 100.0,   8.0,    90.0,     4.0,    500,     1.50,     7600,    5500,      0.50,  2.9, 15.0 }},
      {"Medium Dark Hall",       { 80.0,   5.0,  20.0, 30.0, 100.0,  18.0,    60.0,     4.0,    500,     1.75,     6000,    4000,      0.40,  2.9, 15.0 }},
      {"Medium Percussion Hall", { 80.0,   0.0,  20.0, 30.0,  80.0,  15.0,    40.0,    20.0,    300,     2.00,     5200,    4500,      0.35,  2.0, 12.0 }},
      {"Medium Vocal Hall",      { 80.0,   0.0,  20.0, 32.0,  80.0,   8.0,    75.0,     4.0,    600,     1.50,     6000,    5000,      0.40,  2.8, 16.0 }},
    }
  },
  {
    "Large Halls", {             // dry, early,  late, size, width, delay, diffuse, low cut, low xo, low mult, high cut, high xo, high mult, spin, wander
      ...
      {"Large Vocal Hall",       { 75.0,   0.0,  25.0, 40.0,  80.0,  12.0,    80.0,     4.0,    700,     2.25,     6000,    4500,      0.30,  2.1, 17.0 }},
      {"Great Hall",             { 70.0,   0.0,  30.0, 50.0,  90.0,  20.0,    95.0,     4.0,    750,     2.50,     5600,    4000,      0.30,  2.6, 22.0 }},
    }
  }
};
